...
urlpatterns = [
    ...
    path('rebaseSets', views.rebaseSets, name='rebaseSets'),
    path('reloadBaseFileSets', views.reloadBaseFileSets, name='reloadBaseFileSets'),
    ...
    path('updllvl', views.updateLogLevel, name='updateLogLevel'),
